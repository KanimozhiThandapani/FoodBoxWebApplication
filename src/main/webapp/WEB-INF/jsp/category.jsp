...
<body style="background-color:lightblue;">
   ...
   <div class="city" align="center">
    ...
    <div class="container">
       <img src="Biriyani.jpg" alt="Snow" style="width:20%">
       <button class="btn" type="button" onClick="redirect()">Confirm Order And Pay</button>
    </div>
    </div>
...
//Submits form
function redirect() {
   window.open("http://localhost:8081/payment")
}
</script>
